...
No adapters required to run **Allocate a Pair of Numbers - IAP**.
...
Please use your Itential Customer Success account if you need support when using **Allocate a Pair of Numbers - IAP**.